...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/predix/apis.md
...
- name: SAS ESP Predix Service API - ESP server health check
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/predix/v1proxyserver-head-openapi.md
- name: SAS ESP Predix Service API - ESP server health check
  x-api-slug: v1proxyserver-head
  description: API to to check health of ESP server.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/predix-vector-logo.png
