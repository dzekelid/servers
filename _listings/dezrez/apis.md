...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/dezrez/apis.md
...
- name: "Dezrez.Rezi.Client.Api - Creates or Updates Email Sync Security Credentials\r\nThis
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/dezrez/apicredentialsemailsyncusernamepassword-post-openapi.md
- name: "Dezrez.Rezi.Client.Api - Creates or Updates Email Sync Security Credentials\r\nThis
    also uses the credentials to do a quick check and see if they are working\r\nit
    will throw an internal server error if there is an issue with the connection\r\nbut
    this may be the server address (s"
