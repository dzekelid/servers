...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/aws-route-53/apis.md
...
- name: AWS Route 53 API - Get Checker Ip Ranges
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/aws-route-53/20130401checkeripranges-get-openapi.md
- name: AWS Route 53 API - Create Reusable Delegation Set
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/servers/master/_listings/aws-route-53/20130401delegationset-post-openapi.md
- name: AWS Route 53 API - Get Checker Ip Ranges
  x-api-slug: 20130401checkeripranges-get
  description: GetCheckerIpRanges still works, but we recommend that you download
    ip-ranges.json, which includes IP address ranges for all AWS services. For more
